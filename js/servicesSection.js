...
// ── Create DOM elements first, measure them, THEN create physics bodies ───
const blocks = [];
 
// Step 1: create & append all elements offscreen so we can measure them
...
function sync() {
  blocks.forEach(({ body, el, w, h, isDrotviaz, restX, restY, restAngle, floatPhase }, i) => {
